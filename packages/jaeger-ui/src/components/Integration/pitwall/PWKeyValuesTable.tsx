...
import CoralogixLink from './CoralogixLink';
import GrafanaLink from './GrafanaLink';
import MoxdbLink from './MoxdbLink';

import { TNil } from '../../../types';
import { KeyValuePair, Link } from '../../../types/trace';

import './PWKeyValuesTable.css';
...
export default function PWKeyValuesTable(props: PWKeyValuesTableProps) {
  const { data, traceStartTime, traceID, linksGetter } = props;
  return (
          ...
          {data.map((row, i) => {
            ...
            return (
              ...
              <tr className="KeyValueTable--row" key={`${row.key}-${i}`}>
                ...
                <td>{valueMarkup}</td>
                <td className="KeyValueTabel--copyColumn">
                  <CoralogixLink
                    className="KeyValueTable--copyColumn"
                    k={row.key}
                    value={row.value}
                ...
                <td className="KeyValueTabel--copyColumn">
                  <GrafanaLink
                    className="KeyValueTabel--copyColumn"
                    k={row.key}
                    value={row.value}
                    traceStartTime={traceStartTime}
                    traceID={traceID}
